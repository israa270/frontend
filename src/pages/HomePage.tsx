    ...
    <div className="min-h-svh bg-background px-4 py-8">
      <header className="mx-auto flex max-w-3xl flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <Link
            to="/login"
            className="rounded-lg border border-primary px-4 py-2.5 text-sm font-semibold text-primary no-underline hover:bg-surface-low focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
          >
            Log in
          </Link>
          <Link
